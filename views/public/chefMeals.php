...
<?php foreach($menus as $meal){?>
    ...
    <div class="card card mt-3 mb-5" >
      <div class="row g-0">
       
        <div class="col-5 m-2 mt-5">
          <img src="./assets/pictures/<?=$meal->getPicture_meal();?>" alt="..." width="400px">
          <h5 class="card-title ml-2 mb-4"><?=$meal->getName_meal();?> by <?=strtoupper($meal->getChef()->getName_chef());?></h5>
        </div>
        <div class="col mt-5">
          <div class="card-body">
            ...
            <form action="index.php?action=checkout" method="post">
              ...
              <input id="priceItem" type="hidden" name="price" value="<?=$meal->getPrice();?>">
